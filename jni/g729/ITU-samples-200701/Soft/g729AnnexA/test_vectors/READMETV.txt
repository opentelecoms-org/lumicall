...
of the G.729A ANSI-C software (version 1.1). NOTE that these vectors
...
The way the decoder of version 1.0 was detecting frame erasure was incorrect.
In this version the frame erasure is detected the same way as in G.729.
The impact of this correction is that the file "overflow.pst" is different
from version 1.0.
